  ...
  return (
    <footer className="footer-custom">
      ...
      <style jsx>{`
        ...
        .social-btn { background: #ffd700; color: #000; width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center; }
        .footer__links { list-style: none; }
        .footer__links li { margin-bottom: 0.5rem; }
        .footer__links a { display: flex; align-items: center; gap: 0.5rem; }
        .footer__access { display: flex; flex-direction: column; gap: 0.75rem; }
        .access-btn { padding: 0.75rem; border-radius: 6px; text-align: center; font-weight: 700; }
        .access-btn--portal { background: #ffd700; color: #000; }
        .access-btn--admin { border: 1px solid white; color: white; }
